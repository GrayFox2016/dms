...
$(function () {
    ...
    var menus = [
        {
            title: 'Cluster', icon: 'icon-list', list: [
                { title: 'Overview', page: 'cluster_overview' },
                { title: 'Cluster List', page: 'cluster_list' },
                { title: 'Namespace List', page: 'cluster_namespace' },
                { title: 'Application List', page: 'cluster_app' },
                { title: 'User Permit', page: 'cluster_permit' }
            ]
        },
        {
            title: 'Image Config', icon: 'icon-list', list: [
                { title: 'Image Registry', page: 'image_registry' },
                { title: 'Image Volume', page: 'image_volume' },
                { title: 'Image Env', page: 'image_env' },
                { title: 'Image Port', page: 'image_port' },
                { title: 'Container Template', page: 'image_tpl' }
            ]
        },
        {
            title: 'Gateway', icon: 'icon-list', list: [
                { title: 'Overview', page: 'gateway_overview' },
                { title: 'Traefik Cluster List', page: 'gateway_cluster' }
            ]
        },
        {
            title: 'Agent Script', icon: 'icon-list', list: [
                { title: 'Script List', page: 'script_list' },
                { title: 'Agent Visit History', page: 'script_pull-log' }
            ]
        }
    ];
